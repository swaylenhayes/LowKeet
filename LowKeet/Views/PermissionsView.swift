            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text("LowKeet requires the following permissions to function properly")
                            .font(.system(size: 15))
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use LowKeet anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow LowKeet to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow LowKeet to paste transcribed text directly at your cursor position",
                        ...
                        infoTipMessage: "LowKeet uses Accessibility permissions to paste the transcribed text directly into other applications at your cursor's position. This allows for a seamless dictation experience across your Mac."
                    )
                    ...
                    PermissionCard(
                        ...
                        description: "Allow LowKeet to understand context from your screen for transcript Enhancement",
                        ...
                        infoTipMessage: "LowKeet captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
                        infoTipLink: "https://trylowkeet.com/docs/contextual-awareness"
                    )
                }
            }
            .padding(24)
