        ...
        ScrollView {
            VStack(spacing: 24) {
                SettingsSection(
                    ...
                    subtitle: "Choose how you want to trigger Voice Memo"
                ) {
                ...
                SettingsSection(
                    ...
                    subtitle: "Additional shortcuts for Voice Memo"
                ) {
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            HStack(spacing: 8) {
                                ...
                                InfoTip(
                                    ...
                                    message: "Use middle mouse button to toggle LowKeet recording."
                                )
                            }
                ...
                // OFFLINE MODE: Removed PowerModeSettingsSection
                ...
                SettingsSection(
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        // DISABLED: Auto-update settings (not needed for open source distribution)
                        ...
                        // OFFLINE MODE: Removed announcements toggle

                        // DISABLED: Manual update check (not needed for open source distribution)
                        ...
                        // DISABLED: Removed divider since onboarding reset is also disabled
                        // Divider()

                        // DISABLED: Onboarding reset (not needed for open source distribution)
            ...
            HStack(spacing: 12) {
                ...
                if showWarning {
                    ...
                    Image(systemName: "exclamationmark.triangle.fill")
                        .foregroundColor(.red)
                        .help("Permission required for LowKeet to function properly")
                }
            }
