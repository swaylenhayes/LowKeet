...
struct KeyboardShortcutsListView: View {
    ...
    // OFFLINE MODE: Removed EnhancementShortcutSettings
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Quick reference for all LowKeet shortcuts")
            ...
            ScrollView {
                LazyVGrid(columns: [
                    ...
                    // OFFLINE MODE: Removed AI enhancement and PowerMode shortcut cards
                }
