...
// MARK: - Shared Popover State (OFFLINE MODE: Removed enhancement and power cases)
...
// OFFLINE MODE: Removed RecorderPromptButton (AI enhancement) and PowerMode button components
...
struct RecorderStatusDisplay: View {
    ...
    var body: some View {
        Group {
            // OFFLINE MODE: Removed .enhancing state
