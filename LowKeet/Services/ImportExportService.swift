...
struct LowKeetExportedSettings: Codable {
    let version: String
...
class ImportExportService {
    ...
    @MainActor
    func exportSettings(whisperPrompt: WhisperPrompt, hotkeyManager: HotkeyManager, menuBarManager: MenuBarManager, mediaController: MediaController, playbackController: PlaybackController, soundManager: SoundManager, whisperState: WhisperState) {
        ...
        let exportedSettings = LowKeetExportedSettings(
        ...
        do {
            ...
            savePanel.nameFieldStringValue = "LowKeet_Settings_Backup.json"
            savePanel.title = "Export LowKeet Settings"
    ...
    @MainActor
    func importSettings(whisperPrompt: WhisperPrompt, hotkeyManager: HotkeyManager, menuBarManager: MenuBarManager, mediaController: MediaController, playbackController: PlaybackController, soundManager: SoundManager, whisperState: WhisperState) {
        let openPanel = NSOpenPanel()
        openPanel.allowedContentTypes = [UTType.json]
        openPanel.canChooseFiles = true
        openPanel.canChooseDirectories = false
        openPanel.allowsMultipleSelection = false
        openPanel.title = "Import LowKeet Settings"
        ...
        DispatchQueue.main.async {
            if openPanel.runModal() == .OK {
                ...
                do {
                    ...
                    let importedSettings = try decoder.decode(LowKeetExportedSettings.self, from: jsonData)
                    ...
                    // OFFLINE MODE: Custom cloud models not supported
