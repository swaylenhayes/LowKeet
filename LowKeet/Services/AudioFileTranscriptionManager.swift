...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.swaylenhayes.apps.lowkeet", category: "AudioTranscriptionManager")
    
    // Transcription services - will be initialized when needed (OFFLINE MODE: Only local services)
    ...
    func startProcessing(url: URL, modelContext: ModelContext, whisperState: WhisperState) {
        ...
        currentTask = Task {
            do {
                ...
                // OFFLINE MODE: No PowerMode support
                ...
                // OFFLINE MODE: No AI enhancement support
