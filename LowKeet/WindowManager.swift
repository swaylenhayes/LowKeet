...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("com.swaylenhayes.apps.lowkeet.mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("com.swaylenhayes.apps.lowkeet.onboardingWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("LowKeetMainWindowFrame")
    ...
    func configureOnboardingPanel(_ window: NSWindow) {
        ...
        window.title = "LowKeet Onboarding"
